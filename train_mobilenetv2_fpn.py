...
parser.add_argument('--dataset_root', default='/media/mario/新加卷/DataSets/ALPR',
                    help='Dataset root directory path')
parser.add_argument('--basenet', default=None, #'mobilenetv2.pth.tar',
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration != 0 and iteration % 5000 == 0:
            ...
            torch.save(ssd_net.state_dict(), 'weights/mobilenetv2_fpn_' +
                       repr(iteration) + '.pth')
    torch.save(ssd_net.state_dict(), 'weights/mobilenetv2_fpn_final' + '.pth')
